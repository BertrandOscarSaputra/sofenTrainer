...
const MOCK_TRAINERS: Trainer[] = [
  {
    ...
    userId: 2,
    name: "Budi Santoso",
    bio: "Certified personal trainer dengan 5 tahun pengalaman di bidang strength training dan functional fitness.",
  ...
  },
  {
    ...
    userId: 3,
    name: "Sari Dewi",
    bio: "Spesialis yoga dan pilates, membantu klien mencapai keseimbangan tubuh dan pikiran.",
  ...
  },
  {
    ...
    userId: 4,
    name: "Andi Pratama",
    bio: "Mantan atlet marathon, spesialis cardio dan endurance training untuk semua level.",
  ...
  },
  {
    ...
    userId: 5,
    name: "Maya Lestari",
    bio: "CrossFit level 2 trainer, fokus pada high intensity interval training dan body transformation.",
  ...
  },
  {
    ...
    userId: 6,
    name: "Rudi Hermawan",
    bio: "Ahli rehabilitasi cedera dan mobility training, membantu recovery pasca cedera olahraga.",
  ...
  },
  {
    ...
    userId: 7,
    name: "Dina Safitri",
    bio: "Pelatih boxing dan muay thai, menggabungkan martial arts dengan fitness untuk latihan menyenangkan.",
...
const MOCK_BOOKINGS: Booking[] = [
  ...
  },
  {
    ...
    trainerId: 2,
    scheduleId: 5,
    bookedAt: "2026-05-03T08:00:00",
    durationMinutes: 60,
    status: "DONE",
    trainer: MOCK_TRAINERS[1],
    schedule: MOCK_SCHEDULES[4],
  },
  {
    id: 3,
    userId: 1,
    trainerId: 3,
    scheduleId: 9,
    bookedAt: "2026-05-01T17:00:00",
    durationMinutes: 60,
    status: "DONE",
    trainer: MOCK_TRAINERS[2],
    schedule: MOCK_SCHEDULES[8],
  },
];
...
export async function getTrainers(): Promise<Trainer[]> {
  ...
  const res = await api.get<TrainerApiResponse[]>("/api/trainers");
  return res.data.map((trainer) => ({
    id: trainer.id,
    userId: trainer.userId,
    name: trainer.name || trainer.trainerName || `Trainer #${trainer.id}`,
    bio: trainer.bio || "",
    specialty: trainer.specialty || "-",
    rating: Number(trainer.rating ?? 0),
    avatarUrl: trainer.avatarUrl || trainer.profilePictureUrl,
  }));
}
  ...
  if (USE_MOCK) {
    const newBooking: Booking = {
      ...
      schedule: data.scheduleId
        ? MOCK_SCHEDULES.find((s) => s.id === data.scheduleId)
        : undefined,
    };
