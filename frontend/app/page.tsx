...
const features = [
  {
    ...
    title: "Booking Mudah",
    description:
      "Pilih trainer, pilih jadwal, dan booking dalam hitungan detik. Tanpa ribet, tanpa antri.",
  ...
  },
  {
    ...
    description:
      "Google Gemini menganalisis kebiasaan latihanmu dan menyarankan jadwal optimal untuk minggu depan.",
  ...
  },
  {
    ...
    description:
      "Trainer menyediakan berbagai slot waktu. Pagi, siang, atau sore — semua tersedia.",
...
const steps = [
  {
    step: "01",
    title: "Pilih Trainer",
    desc: "Browse trainer berdasarkan spesialisasi dan rating.",
  },
  {
    step: "02",
    title: "Pilih Jadwal",
    desc: "Lihat slot waktu yang tersedia dan pilih yang cocok.",
  },
  {
    step: "03",
    title: "Booking & Latihan",
    desc: "Konfirmasi booking dan mulai sesi latihanmu!",
  },
];
    ...
    <div className="min-h-screen bg-[#0A0F1E]">
      ...
      <section className="relative pt-32 pb-20 px-4 overflow-hidden">
        ...
        <div className="relative max-w-5xl mx-auto text-center">
          {/* Headline */}
          <h1
            className="text-5xl sm:text-6xl lg:text-7xl font-extrabold leading-tight mb-6 animate-slide-up delay-100"
          ...
          <p className="text-lg sm:text-xl text-gray-400 max-w-2xl mx-auto mb-10 leading-relaxed animate-slide-up delay-200">
            Booking sesi latihan dengan trainer profesional. Dapatkan
            rekomendasi jadwal personal yang disesuaikan dengan kebiasaan dan
            pola latihanmu.
          </p>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-400 max-w-lg mx-auto">
              Semua yang kamu butuhkan untuk mengatur jadwal latihan dengan
              efisien.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {features.map((feature, i) => (
              ...
              >
                <div
                  className={`w-12 h-12 rounded-2xl bg-gradient-to-br ${feature.gradient} flex items-center justify-center mb-5 group-hover:scale-110 transition-transform duration-300 shadow-lg`}
                >
        ...
        <div className="relative max-w-4xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-400">
              3 langkah mudah untuk mulai latihan.
            </p>
          </div>
      ...
      <section id="trainers" className="py-24 px-4">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-400 max-w-lg mx-auto">
              Trainer bersertifikat dengan pengalaman di berbagai bidang
              fitness.
            </p>
          </div>
          ...
          <Card className="text-center py-12 px-8 relative overflow-hidden glow-indigo">
            ...
            <div className="relative">
              ...
              <p className="text-gray-400 mb-8 max-w-md mx-auto">
                Daftar sekarang dan biarkan AI membantu merencanakan jadwal
                latihan optimalmu.
              </p>
              <Link href="/register">
                <Button size="lg" variant="primary">
